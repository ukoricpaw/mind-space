...
import { ArticleActions, IArticle, ITag } from './article.constants';
...
export const articleSuccessAction = createAction(ArticleActions.ARTICLE_SUCCESS, props<{ article: IArticle }>());
